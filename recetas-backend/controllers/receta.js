...
receta.modificar = async (req, res) => {
    ...
    const editareceta = async function(Costo, Tiempo, Dificultad, Porciones, Lugar, Tipo_de_cocina, Ingredientes, Texto, id, Usuario){
        ...
        console.log(Costo, Tiempo, Dificultad, Porciones, Lugar, Tipo_de_cocina, Ingredientes, Texto, id, Usuario)
        return rowsE;
    }

    validatoken(req.body.Token)
    .then((user) => validausuario(user))
    .then((rowsU) => editareceta(req.body.Costo, req.body.Tiempo, req.body.Dificultad, req.body.Porciones, req.body.Lugar, req.body.Tipo_de_cocina, req.body.Ingredientes, req.body.Texto, req.body.id, Usuario))
